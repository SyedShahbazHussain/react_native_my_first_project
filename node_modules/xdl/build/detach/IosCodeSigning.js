...
let buildIPA = (() => {
  var _ref4 = _asyncToGenerator(function* ({
    ...
    if (client) {
      ...
      yield runFastlane(credentials, ['gym', '-n', _path.default.basename(ipaPath), '--workspace', workspacePath, '--archive_path', archivePath, '--skip_build_archive', 'true', '-i', codeSignIdentity, '--export_options', exportOptionsPlistPath, '--export_method', exportMethod, '--export_xcargs', `OTHER_CODE_SIGN_FLAGS="--keychain ${keychainPath}"`, '-o', _path.default.dirname(ipaPath), '--verbose'], { buildPhase: 'building and signing IPA' });
    }
  });
