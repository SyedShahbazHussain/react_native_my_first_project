...
exports.stopAsync = exports.startAsync = exports.getUrlAsync = exports.setOptionsAsync = exports.stopTunnelsAsync = exports.startTunnelsAsync = exports.bundleWebpackAsync = exports.stopExpoServerAsync = exports.startExpoServerAsync = exports.stopReactNativeServerAsync = exports.startReactNativeServerAsync = exports.buildAsync = exports.publishAsync = exports.findReusableBuildAsync = exports.exportForAppHosting = exports.mergeAppDistributions = exports.getLatestReleaseAsync = exports.getSlugAsync = exports.getManifestUrlWithFallbackAsync = exports.currentStatus = undefined;
...
let findReusableBuildAsync = exports.findReusableBuildAsync = (() => {
  var _ref16 = _asyncToGenerator(function* (releaseChannel, platform, sdkVersion, slug) {
    const user = yield (_User || _load_User()).default.getCurrentUserAsync();

    const buildReuseStatus = yield (_ApiV || _load_ApiV()).default.clientForUser(user).postAsync('standalone-build/reuse', {
      releaseChannel,
      platform,
      sdkVersion,
      slug
  ...
  return function findReusableBuildAsync(_x32, _x33, _x34, _x35) {
...
let publishAsync = exports.publishAsync = (() => {
  ...
  return function publishAsync(_x36) {
    return _ref17.apply(this, arguments);
  };
})();

let _uploadArtifactsAsync = (() => {
  var _ref18 = _asyncToGenerator(function* ({ exp, iosBundle, androidBundle, options }) {
  ...
  return function _uploadArtifactsAsync(_x37) {
...
let _validatePackagerReadyAsync = (() => {
  ...
  return function _validatePackagerReadyAsync(_x38) {
    return _ref19.apply(this, arguments);
  };
})();

let _getPublishExpConfigAsync = (() => {
  var _ref20 = _asyncToGenerator(function* (projectRoot, options) {
  ...
  return function _getPublishExpConfigAsync(_x39, _x40) {
...
let _buildPublishBundlesAsync = (() => {
  var _ref21 = _asyncToGenerator(function* (projectRoot, opts) {
  ...
  return function _buildPublishBundlesAsync(_x41, _x42) {
...
let _maybeBuildSourceMapsAsync = (() => {
  var _ref22 = _asyncToGenerator(function* (projectRoot, exp, options = {}) {
    if (!options.force) {
  ...
  return function _maybeBuildSourceMapsAsync(_x43, _x44) {
...
let _collectAssets = (() => {
  var _ref23 = _asyncToGenerator(function* (projectRoot, exp, hostedAssetPrefix) {
    let entryPoint = yield (_Exp || _load_Exp()).determineEntryPointAsync(projectRoot);
    ...
    yield _resolveManifestAssets(projectRoot, exp, (() => {
      var _ref24 = _asyncToGenerator(function* (assetPath) {
  ...
  return function _collectAssets(_x45, _x46, _x47) {
...
let _configureExpForAssets = (() => {
  var _ref25 = _asyncToGenerator(function* (projectRoot, exp, assets) {
  ...
  return function _configureExpForAssets(_x49, _x50, _x51) {
    return _ref25.apply(this, arguments);
  };
})();

let _fetchAndUploadAssetsAsync = (() => {
  var _ref26 = _asyncToGenerator(function* (projectRoot, exp) {
  ...
  return function _fetchAndUploadAssetsAsync(_x52, _x53) {
    return _ref26.apply(this, arguments);
  };
})();

let _fetchAndSaveAssetsAsync = (() => {
  var _ref27 = _asyncToGenerator(function* (projectRoot, exp, hostedUrl, outputDir) {
    (_Logger || _load_Logger()).default.global.info('Analyzing assets');
  ...
  return function _fetchAndSaveAssetsAsync(_x54, _x55, _x56, _x57) {
    return _ref27.apply(this, arguments);
  };
})();

let _writeArtifactSafelyAsync = (() => {
  var _ref28 = _asyncToGenerator(function* (projectRoot, keyName, artifactPath, artifact) {
  ...
  return function _writeArtifactSafelyAsync(_x58, _x59, _x60, _x61) {
...
let _maybeWriteArtifactsToDiskAsync = (() => {
  ...
  return function _maybeWriteArtifactsToDiskAsync(_x62) {
    return _ref29.apply(this, arguments);
  };
})();

let _handleKernelPublishedAsync = (() => {
  var _ref30 = _asyncToGenerator(function* ({ projectRoot, user, exp, url }) {
  ...
  return function _handleKernelPublishedAsync(_x63) {
...
let uploadAssetsAsync = (() => {
  var _ref31 = _asyncToGenerator(function* (projectRoot, assets) {
    // Collect paths by key, also effectively handles duplicates in the array
    const paths = {};
    assets.forEach(function (asset) {
      asset.files.forEach(function (path, index) {
    ...
    yield Promise.all((0, (_chunk || _load_chunk()).default)(missing, 5).map((() => {
      var _ref32 = _asyncToGenerator(function* (keys) {
        let formData = new (_FormData || _load_FormData()).default();
        for (const key of keys) {
          (_ProjectUtils || _load_ProjectUtils()).logDebug(projectRoot, 'expo', `uploading ${paths[key]}`);
  ...
  return function uploadAssetsAsync(_x64, _x65) {
...
let _readFileForUpload = (() => {
  ...
  return function _readFileForUpload(_x67) {
...
let getConfigAsync = (() => {
  ...
  return function getConfigAsync(_x68) {
    return _ref34.apply(this, arguments);
  };
})();

let buildAsync = exports.buildAsync = (() => {
  var _ref35 = _asyncToGenerator(function* (projectRoot, options = {}) {
  ...
  return function buildAsync(_x69) {
    return _ref35.apply(this, arguments);
  };
})();

let _waitForRunningAsync = (() => {
  var _ref36 = _asyncToGenerator(function* (projectRoot, url, retries = 300) {
    try {
  ...
  return function _waitForRunningAsync(_x70, _x71) {
    return _ref36.apply(this, arguments);
  };
})();

let startReactNativeServerAsync = exports.startReactNativeServerAsync = (() => {
  var _ref37 = _asyncToGenerator(function* (projectRoot, options = {}, verbose = true) {
    _assertValidProjectRoot(projectRoot);
  ...
  return function startReactNativeServerAsync(_x72) {
...
let stopReactNativeServerAsync = exports.stopReactNativeServerAsync = (() => {
  ...
  return function stopReactNativeServerAsync(_x74) {
    return _ref39.apply(this, arguments);
  };
})();

let startExpoServerAsync = exports.startExpoServerAsync = (() => {
  var _ref40 = _asyncToGenerator(function* (projectRoot) {
    _assertValidProjectRoot(projectRoot);
    ...
    let manifestHandler = (() => {
      var _ref41 = _asyncToGenerator(function* (req, res) {
        try {
          ...
          yield _resolveManifestAssets(projectRoot, manifest, (() => {
            var _ref42 = _asyncToGenerator(function* (path) {
      ...
      return function manifestHandler(_x76, _x77) {
    ...
    app.post('/shutdown', (() => {
      var _ref44 = _asyncToGenerator(function* (req, res) {
        server.close();
        res.send('Success');
      });
  ...
  return function startExpoServerAsync(_x75) {
    return _ref40.apply(this, arguments);
  };
})();

let stopExpoServerAsync = exports.stopExpoServerAsync = (() => {
  var _ref45 = _asyncToGenerator(function* (projectRoot) {
    _assertValidProjectRoot(projectRoot);
    let packagerInfo = yield (_ProjectSettings || _load_ProjectSettings()).readPackagerInfoAsync(projectRoot);
  ...
  return function stopExpoServerAsync(_x83) {
    return _ref45.apply(this, arguments);
  };
})();

let startWebpackServerAsync = (() => {
  var _ref46 = _asyncToGenerator(function* (projectRoot, options) {
    let { exp } = yield (_ProjectUtils || _load_ProjectUtils()).readConfigJsonAsync(projectRoot);
    if (!exp.platforms.includes('web')) {
      return;
    }
    let { dev } = yield (_ProjectSettings || _load_ProjectSettings()).readAsync(projectRoot);
    let config = (0, (_webpackConfig || _load_webpackConfig()).default)({ projectRoot, development: dev, production: !dev });
    let webpackServerPort = yield _getFreePortAsync(19000);
    (_ProjectUtils || _load_ProjectUtils()).logInfo(projectRoot, 'expo', `Starting webpack-dev-server on port ${webpackServerPort}.`);
    let compiler = (0, (_webpack || _load_webpack()).default)(config);
    let server = new (_webpackDevServer || _load_webpackDevServer()).default(compiler, _extends({}, config.devServer, { https: options.https }));
    yield new Promise(function (resolve, reject) {
      return server.listen(webpackServerPort, 'localhost', function (error) {
        if (error) {
          reject(error);
        } else {
          resolve();
  ...
  return function startWebpackServerAsync(_x84, _x85) {
    return _ref46.apply(this, arguments);
  };
})();

let stopWebpackServerAsync = (() => {
  ...
  return function stopWebpackServerAsync(_x86) {
    return _ref47.apply(this, arguments);
  };
})();

let bundleWebpackAsync = exports.bundleWebpackAsync = (() => {
  var _ref48 = _asyncToGenerator(function* (projectRoot, packagerOpts) {
    const hasWebSupport = yield (_Web || _load_Web()).hasWebSupportAsync(projectRoot);
    if (!hasWebSupport) {
      (_Web || _load_Web()).logWebSetup();
      return;
    }
    ...
    let config = (0, (_webpackConfig || _load_webpackConfig()).default)({
      projectRoot,
    ...
    try {
      const stats = yield new Promise(function (resolve, reject) {
        return compiler.run((() => {
          var _ref49 = _asyncToGenerator(function* (error, stats) {
      ...
      const statsPath = _path.default.join(projectRoot, statsDirectory);
      yield (_jsonFile || _load_jsonFile()).default.writeAsync(statsPath, stats.toJson());
    } catch ({ message }) {
      (_ProjectUtils || _load_ProjectUtils()).logError(projectRoot, 'expo', 'There was a problem building your web project. ' + message);
    }
  });

  return function bundleWebpackAsync(_x87, _x88) {
    return _ref48.apply(this, arguments);
  };
})();

let _connectToNgrokAsync = (() => {
  var _ref50 = _asyncToGenerator(function* (projectRoot, args, hostnameAsync, ngrokPid, attempts = 0) {
    try {
  ...
  return function _connectToNgrokAsync(_x91, _x92, _x93, _x94) {
...
let startTunnelsAsync = exports.startTunnelsAsync = (() => {
  ...
  return function startTunnelsAsync(_x95) {
    return _ref51.apply(this, arguments);
  };
})();

let stopTunnelsAsync = exports.stopTunnelsAsync = (() => {
  var _ref56 = _asyncToGenerator(function* (projectRoot) {
    _assertValidProjectRoot(projectRoot);
  ...
  return function stopTunnelsAsync(_x96) {
    return _ref56.apply(this, arguments);
  };
})();

let setOptionsAsync = exports.setOptionsAsync = (() => {
  var _ref57 = _asyncToGenerator(function* (projectRoot, options) {
  ...
  return function setOptionsAsync(_x97, _x98) {
    return _ref57.apply(this, arguments);
  };
})();

let getUrlAsync = exports.getUrlAsync = (() => {
  var _ref58 = _asyncToGenerator(function* (projectRoot, options = {}) {
    _assertValidProjectRoot(projectRoot);
    return yield (_UrlUtils || _load_UrlUtils()).constructManifestUrlAsync(projectRoot, options);
  });

  return function getUrlAsync(_x99) {
    return _ref58.apply(this, arguments);
  };
})();

let startAsync = exports.startAsync = (() => {
  var _ref59 = _asyncToGenerator(function* (projectRoot, options = {}, verbose = true) {
    _assertValidProjectRoot(projectRoot);
    ...
    yield startWebpackServerAsync(projectRoot, options);
  ...
  return function startAsync(_x100) {
    return _ref59.apply(this, arguments);
  };
})();

let _stopInternalAsync = (() => {
  var _ref60 = _asyncToGenerator(function* (projectRoot) {
    (_DevSession || _load_DevSession()).stopSession();
    yield stopExpoServerAsync(projectRoot);
    yield stopReactNativeServerAsync(projectRoot);
    yield stopWebpackServerAsync(projectRoot);
    if (!(_Config || _load_Config()).default.offline) {
      try {
        yield stopTunnelsAsync(projectRoot);
      } catch (e) {
  ...
  return function _stopInternalAsync(_x101) {
    return _ref60.apply(this, arguments);
  };
})();

let stopAsync = exports.stopAsync = (() => {
  var _ref61 = _asyncToGenerator(function* (projectDir) {
  ...
  return function stopAsync(_x102) {
...
function _load_webpackConfig() {
  return _webpackConfig = _interopRequireDefault(require('@expo/webpack-config'));
}
