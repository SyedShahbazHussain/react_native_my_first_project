...
let constructWebAppUrlAsync = exports.constructWebAppUrlAsync = (() => {
  var _ref11 = _asyncToGenerator(function* (projectRoot, { https = false, host = 'localhost' } = {}) {
  ...
  return function constructWebAppUrlAsync(_x30) {
    return _ref11.apply(this, arguments);
  };
})();

let constructUrlAsync = exports.constructUrlAsync = (() => {
  var _ref12 = _asyncToGenerator(function* (projectRoot, opts, isPackager, requestHostname) {
    if (opts) {
  ...
  return function constructUrlAsync(_x31, _x32, _x33, _x34) {
