...
var action = function () {
  var _ref = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)( /*#__PURE__*/(_regenerator || _load_regenerator()).default.mark(function _callee(projectDir, options) {
    var root, startOpts, devToolsUrl, nonInteractive, _ref2, exp, url, recipient;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 41:
            ...
            _context.next = 44;
            return (_TerminalUI || _load_TerminalUI()).startAsync(projectDir, startOpts);
...
exports.default = function (program) {
  program.command('start [project-dir]').alias('r').description('Starts or restarts a local server for your app and gives you a URL to it').option('-s, --send-to [dest]', 'A phone number or e-mail address to send a link to').option('-c, --clear', 'Clear the React Native packager cache').option('--https', 'To start webpack with https protocol')
