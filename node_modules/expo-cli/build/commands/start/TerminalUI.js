...
var _templateObject = (0, (_taggedTemplateLiteral2 || _load_taggedTemplateLiteral()).default)(['i'], ['i']),
    _templateObject2 = (0, (_taggedTemplateLiteral2 || _load_taggedTemplateLiteral()).default)(['w'], ['w']),
    _templateObject3 = (0, (_taggedTemplateLiteral2 || _load_taggedTemplateLiteral()).default)(['a'], ['a']),
    _templateObject4 = (0, (_taggedTemplateLiteral2 || _load_taggedTemplateLiteral()).default)(['A'], ['A']),
    _templateObject5 = (0, (_taggedTemplateLiteral2 || _load_taggedTemplateLiteral()).default)(['c'], ['c']),
    _templateObject6 = (0, (_taggedTemplateLiteral2 || _load_taggedTemplateLiteral()).default)(['d'], ['d']),
    _templateObject7 = (0, (_taggedTemplateLiteral2 || _load_taggedTemplateLiteral()).default)(['shift-d'], ['shift-d']),
    _templateObject8 = (0, (_taggedTemplateLiteral2 || _load_taggedTemplateLiteral()).default)(['D'], ['D']),
    _templateObject9 = (0, (_taggedTemplateLiteral2 || _load_taggedTemplateLiteral()).default)(['e'], ['e']),
    _templateObject10 = (0, (_taggedTemplateLiteral2 || _load_taggedTemplateLiteral()).default)(['p'], ['p']),
    _templateObject11 = (0, (_taggedTemplateLiteral2 || _load_taggedTemplateLiteral()).default)(['r'], ['r']),
    _templateObject12 = (0, (_taggedTemplateLiteral2 || _load_taggedTemplateLiteral()).default)(['shift-r'], ['shift-r']),
    _templateObject13 = (0, (_taggedTemplateLiteral2 || _load_taggedTemplateLiteral()).default)(['s'], ['s']);
...
var printUsage = function () {
  var _ref = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)( /*#__PURE__*/(_regenerator || _load_regenerator()).default.mark(function _callee(projectDir) {
    var _ref2, dev, _ref3, exp, openDevToolsAtStartup, username, devMode, iosInfo, webInfo;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 13:
            ...
            webInfo = exp.platforms.includes('web') ? ', ' + b(_templateObject2) + ' to run on ' + u(_templateObject2) + 'eb' : '';

            (_log || _load_log()).default.nested('\n \u203A Press ' + b(_templateObject3) + ' to run on ' + u(_templateObject4) + 'ndroid device/emulator' + iosInfo + webInfo + '.\n \u203A Press ' + b(_templateObject5) + ' to show info on ' + u(_templateObject5) + 'onnecting new devices.\n \u203A Press ' + b(_templateObject6) + ' to open DevTools in the default web browser.\n \u203A Press ' + b(_templateObject7) + ' to ' + (openDevToolsAtStartup ? 'disable' : 'enable') + ' automatically opening ' + u(_templateObject8) + 'evTools at startup.\n \u203A Press ' + b(_templateObject9) + ' to send an app link with ' + u(_templateObject9) + 'mail/SMS.\n \u203A Press ' + b(_templateObject10) + ' to toggle ' + u(_templateObject10) + 'roduction mode. (current mode: ' + i(devMode) + ')\n \u203A Press ' + b(_templateObject11) + ' to ' + u(_templateObject11) + 'estart bundler, or ' + b(_templateObject12) + ' to restart and clear cache.\n \u203A Press ' + b(_templateObject13) + ' to ' + u(_templateObject13) + 'ign ' + (username ? 'out. (Signed in as ' + i('@' + username) + '.)' : 'in.') + '\n');
...
var printServerInfo = exports.printServerInfo = function () {
  var _ref4 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)( /*#__PURE__*/(_regenerator || _load_regenerator()).default.mark(function _callee2(projectDir) {
        ...
        switch (_context2.prev = _context2.next) {
          ...
          case 5:
            ...
            item = function item(text) {
              return '  \u2022 ' + (0, (_trimStart || _load_trimStart()).default)(wrapItem(text));
            };
            ...
            (_log || _load_log()).default.nested(item('Press ' + b(_templateObject3) + ' for Android emulator' + iosInfo + '.'));
            (_log || _load_log()).default.nested(item('Press ' + b(_templateObject9) + ' to send a link to your phone with email/SMS.'));
            if (!username) {
              (_log || _load_log()).default.nested(item('Press ' + b(_templateObject13) + ' to sign in and enable more options.'));
            }
            printHelp();
...
var startAsync = exports.startAsync = function () {
  var _ref5 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)( /*#__PURE__*/(_regenerator || _load_regenerator()).default.mark(function _callee6(projectDir, options) {
    var handleKeypress = function () {
      var _ref6 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)( /*#__PURE__*/(_regenerator || _load_regenerator()).default.mark(function _callee5(key) {
        var _this = this;

        var _ref7, success, error, _ref8, _success, msg, _ref9, devToolsPort, enabled, lanAddress, defaultRecipient, rl, _handleKeypress, _cleanup, _cancel, projectSettings, dev, reset, authSession;
        ...
        return (_regenerator || _load_regenerator()).default.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                _context5.t0 = key;
                _context5.next = _context5.t0 === CTRL_C ? 3 : _context5.t0 === CTRL_D ? 3 : _context5.t0 === CTRL_L ? 5 : _context5.t0 === '?' ? 7 : _context5.t0 === 'a' ? 10 : _context5.t0 === 'i' ? 19 : _context5.t0 === 'w' ? 28 : _context5.t0 === 'c' ? 34 : _context5.t0 === 'd' ? 38 : _context5.t0 === 'D' ? 46 : _context5.t0 === 'e' ? 55 : _context5.t0 === 'p' ? 71 : _context5.t0 === 'r' ? 81 : _context5.t0 === 'R' ? 81 : _context5.t0 === 's' ? 86 : 109;
                break;
              ...
              case 28:
                clearConsole();
                (0, (_log || _load_log()).default)('Trying to open the project in a web browser...');
                _context5.next = 32;
                return (_xdl || _load_xdl()).Web.openProjectAsync(projectDir, options);
              ...
              case 40:
                ...
                devToolsPort = _ref9.devToolsPort;
              ...
              case 61:
                ...
                _cancel = function () {
                  var _ref10 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)( /*#__PURE__*/(_regenerator || _load_regenerator()).default.mark(function _callee3() {
                ...
                rl.question(defaultRecipient ? '[default: ' + defaultRecipient + ']> ' : '> ', function () {
                  var _ref11 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)( /*#__PURE__*/(_regenerator || _load_regenerator()).default.mark(function _callee4(sendTo) {
                    var sent;
              ...
              case 101:
                _context5.prev = 101;
                _context5.t1 = _context5['catch'](96);
        ...
        }, _callee5, this, [[96, 101, 104, 107]]);
      }));

      return function handleKeypress(_x5) {
  ...
  return function startAsync(_x3, _x4) {
