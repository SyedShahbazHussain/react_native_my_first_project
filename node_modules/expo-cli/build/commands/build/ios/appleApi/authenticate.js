          ...
          case 0:
            ...
            appleIdQuestions = [{
              ...
              message: function message(answer) {
                return 'Password (for ' + (appleId || answer.appleId) + '):';
              },
              validate: (_validators || _load_validators()).nonEmptyInput
            }];
            _context3.t0 = (_extends2 || _load_extends()).default;
            _context3.t1 = { appleId: appleId };
            _context3.next = 8;
...
var _chooseTeam = function () {
  var _ref8 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)( /*#__PURE__*/(_regenerator || _load_regenerator()).default.mark(function _callee4(teams, userProvidedTeamId) {
    var foundTeam, _teams, team, choices, _ref10, _team;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 2:
            ...
            foundTeam = teams.find(function (_ref9) {
...
exports.default = function () {
  var _ref = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)( /*#__PURE__*/(_regenerator || _load_regenerator()).default.mark(function _callee(options) {
    var _ref2, appleId, appleIdPassword, _ref3, teams, team;
...
var _formatTeam = function _formatTeam(_ref11) {
